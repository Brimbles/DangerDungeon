...
def redrawGameWindow():
    ...
    # countyyyy = myfont.render("counter= " + str(counter), 1, (255, 0, 0))
    # screen.blit(countyyyy, (2, 300))
    # skelsinlist = myfont.render("skels to draw= "+ str(len(skeletons)) ,1, (255,0,0))
    # screen.blit(skelsinlist, (2   , 490))
